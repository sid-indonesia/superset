...
Note: All the components required (Firefox headless browser, Redis, Postgres db, celery worker and celery beat) are present in the _dev_ docker image if you are following [Installing Superset Locally](/docs/installation/docker-compose/).
